(function (global, factory) {
  ...
  function reducer$1(state, action, previousState, instance) {
    ...
    if (action.type === actions.toggleRowExpanded) {
      ...
      var isExpanded = state.expanded[id] === true;
      var shouldExpand = typeof setExpanded !== 'undefined' ? setExpanded : !isExpanded;

      if (shouldExpand !== isExpanded) {
        var _extends2;

        return _extends({}, state, {
          expanded: _extends({}, state.expanded, (_extends2 = {}, _extends2[id] = shouldExpand, _extends2))
        });
      } else {
        return state;
      }
  ...
  function useInstance$1(instance) {
    var data = instance.data,
        ...
        _instance$expandRowsI = instance.expandRowsInitially,
        expandRowsInitially = _instance$expandRowsI === void 0 ? false : _instance$expandRowsI,
        getHooks = instance.getHooks,
